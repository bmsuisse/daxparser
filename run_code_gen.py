...
if not os.path.exists("DAXLexer.g4"):
    r = requests.get("https://raw.githubusercontent.com/TabularEditor/TabularEditor/master/AntlrGrammars/DAXLexer.g4")
    r.raise_for_status()
...
subprocess.check_call("java -jar ../antlr4.jar -Dlanguage=Python3 DAXLexer.g4", cwd="daxparser")